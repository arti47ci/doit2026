...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if reactor_efficiency >= 80:
        return "green"
    elif reactor_efficiency >= 60 and reactor_efficiency < 80:
        return "orange"
    elif reactor_efficiency >= 30 and reactor_efficiency <60:
        return "red"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if (temperature * neutrons_produced_per_second) < (threshold * 90/100):
        return "LOW"
    elif (temperature * neutrons_produced_per_second) <= (threshold * 90/100):
        return "NORMAL"
    elif (temperature * neutrons_produced_per_second) <=(threshold * 110/100):
        return "NORMAL"
    else:
        return "DANGER"
